...
10,000反復・199,952 Gaussianのモデルを撮影5位置、反対側レンズ1視点、横移動2視点の計8視点で確認しました。周辺形状の理解用途では、手すりの二重化・床や梁の伸びが残り画質はFAILです。PR3Bでは上流を再利用して20,000反復・197,937 Gaussianの候補を生成しましたが、その候補の画質はNOT_TESTEDです。生成成功と納品可否は別で、衝突・納品・別PC試験もNOT_TESTEDです。
